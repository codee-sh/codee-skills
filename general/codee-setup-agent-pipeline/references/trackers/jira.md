...
At runtime, `codee-setup-agent-pipeline` installs both files and sets `"tracker": "jira"`. The repository's copies are authoritative: teams may add fields, Jira workflow mappings, or project conventions without editing installed skills.
